...
/**
 * Class for connecting to Location Services and removing activity recognition
 * updates. <b> Note: Clients must ensure that Google Play services is available
 * before removing activity recognition updates. </b> Use
 ...
 * 
 */
public class DetectionRemover implements ConnectionCallbacks,
    ...
    /**
     * Remove the activity recognition updates associated with a PendIntent. The
     * PendingIntent is the one used in the request to add activity recognition
     * updates.
     * 
     * @param requestIntent
    ...
    public void removeUpdates(PendingIntent requestIntent) {
        ...
        /*
         * Set the request type, store the List, and request a activity
         * recognition client connection.
         */
    ...
    public ActivityRecognitionClient getActivityRecognitionClient() {
        /*
         * If a client doesn't already exist, create a new one, otherwise return
    ...
    public void onConnected(Bundle connectionData) {
        ...
        // Send a request to Location Services to remove activity recognition
        // updates
        continueRemoveUpdates();
    }

    /**
     * Once the connection is available, send a request to remove activity
     * recognition updates.
     */
