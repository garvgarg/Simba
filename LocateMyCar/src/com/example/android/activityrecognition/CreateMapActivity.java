...
public class CreateMapActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /** 
         * Intent to capture coordinates of Car and User location 
         * send by Main activity
         */
    ...
    /**
     * Sets up the map if it is possible to do so (i.e., the Google Play services
     * APK is correctly installed) and the map has not already been instantiated..
     * This will ensure that we only ever call {@link #setUpMap()} once when 
    ...
    private void drawMarker(LatLng point, String markertitle){
		try{
			...
			/** 
			 * For the User location, the color of marker is GREEN and
			 * for the Car location, the color of marker is RED.
			 */		
